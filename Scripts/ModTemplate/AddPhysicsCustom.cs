...
namespace AstralCodex
{
    ...
    public class AddPhysicsCustom : MonoBehaviour
    {
        ...
        private IEnumerator Start()
        {
            ...
            //Add to Interloper group
            GameObject interloperVolume = SearchUtilities.Find("ZeroG_Volume_Comet_Inside");
            if (interloperVolume != null)
            {
                interloperVolume.GetAddComponent<OWTriggerVolume>().AddObjectToVolume(bodyGo);
            }
            else
                Main.modHelper.Console.WriteLine("FAILED TO FIND COMET VOLUME", OWML.Common.MessageType.Error);
