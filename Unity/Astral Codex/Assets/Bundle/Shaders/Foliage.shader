...
/////// Diffuse:
                ...
                float3 node_8706 = pow((_MainTex_var.rgb*(_Color_var.rgb*_Brightness_var)),_Contrast_var);
                float3 diffuseColor = node_8706;
                float3 diffuse = (directDiffuse + indirectDiffuse) * diffuseColor;
////// Emissive:
                float _EmissionStrength_var = UNITY_ACCESS_INSTANCED_PROP( Props, _EmissionStrength );
                float3 emissive = (node_8706*_EmissionStrength_var);
/// Final Color:
