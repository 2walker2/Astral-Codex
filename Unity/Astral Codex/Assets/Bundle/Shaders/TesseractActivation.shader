...
////// Emissive:
                ...
                float _TimeInput_var = UNITY_ACCESS_INSTANCED_PROP( Props, _TimeInput );
                ...
                float node_2459 = (1.0 - ((_TimeInput_var-_FadeStartDelay_var)*_FadeSpeed_var));
