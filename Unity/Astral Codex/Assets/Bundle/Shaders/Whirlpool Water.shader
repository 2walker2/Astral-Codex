...
Shader "Custom/Refraction" {
    Properties {
        ...
        _RefractionDistortionSpeed ("RefractionDistortionSpeed", Float ) = 0
    ...
    SubShader {
        ...
        Pass {
            ...
            UNITY_INSTANCING_BUFFER_START( Props )
                ...
                UNITY_DEFINE_INSTANCED_PROP( float, _RefractionDistortionSpeed)
            ...
            float4 frag(VertexOutput i, float facing : VFACE) : COLOR {
                ...
                float2 node_3461_piv = float2(0.5,0.5);
                float2 node_3461 = (mul(i.uv0-node_3461_piv,float2x2( node_3461_cos, -node_3461_sin, node_3461_sin, node_3461_cos))+node_3461_piv);
                float4 _RefractionDistortion_var = tex2D(_RefractionDistortion,TRANSFORM_TEX(node_3461, _RefractionDistortion));
