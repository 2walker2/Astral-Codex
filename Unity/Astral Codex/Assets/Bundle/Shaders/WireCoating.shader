...
////// Emissive:
                ...
                float node_5514 = 1.0;
                float3 emissive = lerp((_BaseWireColorFactor_var*_HighlightColor_var.rgb),_HighlightColor_var.rgb,smoothstep( (_StripeThickness_var+node_7812), node_7812, min(min(distance(node_9592,node_1050),distance(node_9592,(node_1050+node_5514))),distance(node_9592,(node_1050-node_5514))) ));
/// Final Color:
