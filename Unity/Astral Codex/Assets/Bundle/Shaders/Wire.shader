...
/// Final Color:
                ...
                outEmission = half4( lerp(_EdgeColor_var.rgb,lerp((_BaseWireColorFactor_var*_HighlightColor_var.rgb),_HighlightColor_var.rgb,smoothstep( (_StripeThickness_var+node_7812), node_7812, min(min(distance(node_9592,node_1050),distance(node_9592,(node_1050+node_5514))),distance(node_9592,(node_1050-node_5514))) )),_Pattern_var.a), 1 );
                #ifndef UNITY_HDR_ON
