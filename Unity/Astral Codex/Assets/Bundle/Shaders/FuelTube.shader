...
////// Emissive:
                ...
                float3 node_7951 = lerp(_PrimaryColor_var.rgb,_SecondaryColor_var.rgb,(_Noise_var.r*_NoiseContrast_var));
                ...
                float node_5514 = 1.0;
                float3 node_3669 = lerp((_BaseWireColorFactor_var*node_7951),node_7951,smoothstep( (_StripeThickness_var+node_7812), node_7812, min(min(distance(node_9592,node_1050),distance(node_9592,(node_1050+node_5514))),distance(node_9592,(node_1050-node_5514))) ));
