...
////// Lighting:
                ...
                fixed4 finalRGBA = fixed4(finalColor,(pow(((1.0 - smoothstep( (_EdgeFadeDistance_var-_EdgeFadeSoftness_var), _EdgeFadeDistance_var, node_1831 ))*_Texture_var.r),_Contrast_var)*_Strength_var));
